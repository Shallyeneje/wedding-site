    ...
    <header>
      ...
      <nav
        ...
        className={`fixed z-20 w-full transition-all duration-300 ${
          isScrolled
            ? "backdrop-blur-xl bg-[#0f172a]/80 border-b border-white/10 shadow-lg"
            : "bg-transparent"
        }`}
      >
        <div className="m-auto max-w-6xl px-6">
          <div className="flex flex-wrap items-center justify-between py-3 lg:py-4">
            ...
            <div
              ...
              } lg:flex flex-col lg:flex-row items-center gap-8 absolute lg:static top-full left-0 w-full lg:w-auto bg-[#0f172a]/95 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border-t lg:border-none border-white/10 p-6 lg:p-0`}
            >
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  {/* underline animation */}
                  <span className="absolute left-0 -bottom-1 h-0.5 w-0 bg-[#1e3a8a] transition-all duration-300 group-hover:w-full" />
                </Link>
              ))}
            </div>
          </div>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full shadow-xl transition-all duration-300 flex items-center justify-center ${
          showScrollTop
            ? "opacity-100 translate-y-0"
            : "opacity-0 translate-y-16 pointer-events-none"
        } bg-[#1e3a8a] hover:bg-[#1e40af] hover:scale-110`}
      >
