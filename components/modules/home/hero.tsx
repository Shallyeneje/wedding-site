...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0f1f] text-gray-200">
      ...
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(ellipse 60% 50% at 80% 80%, rgba(20,40,80,0.35), transparent 70%)
          `,
        }}
      />
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center px-6 md:px-12 lg:px-20 py-12 relative">
            ...
            <div className="max-w-xl z-10">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
              >
                <h1 className="text-6xl sm:text-8xl md:text-7xl lg:text-8xl font-gothic font-light tracking-wide mb-2 bg-linear-to-r from-[#c8aa78] via-white to-[#c8aa78] bg-clip-text text-transparent">
                  Miracle & Shalom
                </h1>

                <div className="flex items-center justify-center md:justify-start gap-3 mt-4">
                  <div className="h-px w-12 bg-linear-to-r from-transparent to-[#c8aa78]" />
                  <p className="text-base md:text-lg tracking-widest uppercase text-gray-400">
                    May 09, 2026
                  </p>
